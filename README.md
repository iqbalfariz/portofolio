...
**Hello, I am an Android developer who enjoys working in collaborative teams and continuously strives to gain valuable experience in order to create exceptional Android apps. Previously, I am an Android intern at Bluebird Group, working on the MyBluebird project using the Kotlin programming language and Android Studio.**
<br><br><br>
